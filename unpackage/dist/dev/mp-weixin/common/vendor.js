...
var store = new _vuex.default.Store({
  ...
  getters: {
    phone: function phone(state) {return state.phone;},
    clientname: function clientname(state) {return state.clientname;},
    clienttype: function clienttype(state) {return state.clienttype;},
    certificatetype: function certificatetype(state) {return state.certificatetype;},
    certificateno: function certificateno(state) {return state.certificateno;},
    gender: function gender(state) {return state.gender;},
    birthday: function birthday(state) {return state.birthday;},
    nation: function nation(state) {return state.nation;},
    address: function address(state) {return state.address;},
    company: function company(state) {return state.company;} },
...
/***/ 13:
/*!************************************!*\
  !*** E:/project/维修工人/api/index.js ***!
  \************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
var _request = _interopRequireDefault(__webpack_require__(/*! @/common/request.js */ 14));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
module.exports = {
  // 登录
  login: function login(data) {
    return (0, _request.default)('api/maintLogin', 'post', data);
  },
  // 修改密码
  editMaintPwd: function editMaintPwd(data) {
    return (0, _request.default)("api/editMaintPwd?id=".concat(data.id, "&&oldPwd=").concat(data.oldPwd, "&&nowPwd=").concat(data.nowPwd), 'POST', data);
  },
  // 所有工单
  getAllOrderList: function getAllOrderList(data) {
    return (0, _request.default)("api/getAllOrderList", "get", data);
  },
  // 维修接单
  saveRecent: function saveRecent(data) {
    return (0, _request.default)("api/saveRecent?orderId=".concat(data.orderId, "&&workerId=").concat(data.workerId), "post");
  },
  // 报修工单列表
  getOrderListByMaint: function getOrderListByMaint(data) {
    return (0, _request.default)('api/getOrderListByMaint', 'get', data);
  },
  // 完成维修
  saveReceives: function saveReceives(data) {
    return (0, _request.default)("api/saveReceives?orderId=".concat(data.orderId, "&&remark=").concat(data.remark, "&&receImgs=").concat(data.receImgs), 'post');
  },
  /* 获取维修工信息 */
  getMaintById: function getMaintById(data) {
    return (0, _request.default)('/api/getMaintById', "get", data);
  },
  ...
  getReports: function getReports() {
    return (0, _request.default)("api/getReports", "get");
  },
  // 获取报修类型
  getWarrs: function getWarrs() {
    return (0, _request.default)("api/getWarrs", "get");
  },
  // 提交报修工单
  saveWorkOrder: function saveWorkOrder(data) {
    return (0, _request.default)("api/saveWorkOrder", "post", data);
  },
  // 提交建议
  saveComplaint: function saveComplaint(data) {
    return (0, _request.default)("api/saveComplaint", "post", data);
  },
  // 报修工单列表
  getOrderByClientId: function getOrderByClientId(data) {
    return (0, _request.default)("api/getOrderByClientId", "get", data);
  },
  // 建议列表
  getComplaintByClientId: function getComplaintByClientId(data) {
    return (0, _request.default)("api/getComplaintByClientId", "get", data);
  },
  // 广告
  getAdvers: function getAdvers() {
    return (0, _request.default)("api/getAdvers", "get");
  },
  // 公告列表
  getNoticeList: function getNoticeList(data) {
    return (0, _request.default)("api/getNoticeList", "get", data);
  },
  // 申请车位
  saveApplyCar: function saveApplyCar(data) {
    return (0, _request.default)("api/saveApplyCar", "post", data);
  },
  // 报修工单详情
  getOrderById: function getOrderById(data) {
    return (0, _request.default)("api/getOrderById", "get", data);
  } };
...
/***/ 14:
/*!*****************************************!*\
  !*** E:/project/维修工人/common/request.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 15:
/*!****************************************!*\
  !*** E:/project/维修工人/common/config.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 271:
/*!*****************************************************!*\
  !*** E:/project/维修工人/components/uni-icons/icons.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 71:
/*!**************************************************!*\
  !*** E:/project/维修工人/pages.json?{"type":"stat"} ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__002DE11" };exports.default = _default;
